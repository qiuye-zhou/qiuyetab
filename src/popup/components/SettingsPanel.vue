...
<template>
  ...
  <div
    v-if="showSettings"
    class="fixed inset-0 bg-white dark:bg-gray-800 z-[9999] flex flex-col"
  >
    <div
    ...
    <div class="flex-1 overflow-y-auto p-4">
      <div class="space-y-6">
        <!-- 搜索引擎设置 -->
        <div>
          <h3 class="text-md font-medium text-gray-700 dark:text-gray-200 mb-3">
            搜索引擎
          </h3>
          <div>
            <label
